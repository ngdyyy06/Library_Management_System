...
import { loginUser, getCurrentUserRole } from "@/app/lib/api";
                                    ...
                                    {showPassword ? (
                                        ...
                                        >
                                            <path
                                                strokeLinecap="round"
                                                strokeLinejoin="round"
                                                d="M3 3l18 18M10.58 10.58a2 2 0 002.83 2.83M9.88 5.08A10.8 10.8 0 0112 4.88c5.25 0 9.75 7.12 9.75 7.12a18.3 18.3 0 01-3.02 3.72M6.61 6.61C3.93 8.36 2.25 12 2.25 12s3.5 6 9.75 6c1.38 0 2.65-.3 3.8-.79"
                                            />
                                        </svg>
                                    )}
                                </button>
