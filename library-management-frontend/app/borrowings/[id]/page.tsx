...
export default function BorrowingDetailPage() {
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            .then(([borrowingData, detailsData]) => {
                    ...
                    <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <div className="mb-2 flex items-center gap-2 text-xs font-medium text-slate-400">
                                <span className="hover:text-slate-600 cursor-pointer" onClick={() => router.push("/borrowings")}>
                                    Borrowings
                                </span>
                                <span>/</span>
                                <span className="text-slate-700 font-semibold">Record #{id}</span>
                            </div>
                            ...
                            <div className="flex items-center gap-2.5">
                                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-amber-50 text-amber-600 border border-amber-100">
                                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.121 5.121A1 1 0 0118 9.121V19a2 2 0 01-2 2z" />
                                    </svg>
                                </div>
                            ...
                            <div className="rounded-xl border border-slate-100 bg-slate-50/50 p-4">
                                ...
                                <div className="mt-2 flex items-center gap-2.5">
                                    <div className="flex h-7 w-7 items-center justify-center rounded-lg bg-indigo-100 text-xs font-bold text-indigo-700">
                                        {(borrowing?.reader?.fullName || "R").charAt(0).toUpperCase()}
                                    </div>
                                ...
                                {details.map((detail) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                    <span className={`text-xs font-bold ${hasFine ? "text-rose-600" : "text-slate-600"}`}>
                                                        {(detail.fine ?? 0).toLocaleString("vi-VN")} VND
                                                    </span>
                                            </td>
                                ...
                                {details.length === 0 && (
                                    <tr>
                                        ...
                                        >
                                            ...
                                            <p className="mt-3 text-sm font-semibold text-slate-700">No books found in this record</p>
                                            <p className="mt-1 text-xs text-slate-400">There are no physical book copies attached to this borrowing.</p>
                                        </td>
                                    </tr>
                                )}
                                </tbody>
