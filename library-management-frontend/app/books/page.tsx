...
export default function BooksPage() {
    ...
    const totalAvailable = books
        ...
        .reduce((acc, curr) => acc + (curr.availableQuantity || 0), 0);
            ...
            <div className="mx-auto max-w-7xl space-y-8">
                ...
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                    <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm">
                        ...
                        <p className="mt-2 text-2xl font-extrabold text-slate-900">{books.length}</p>
                        <p className="mt-0.5 text-xs text-slate-400">Unique book entries</p>
                    </div>
                    ...
                    <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm">
                        ...
                        <p className="mt-2 text-2xl font-extrabold text-emerald-700">{totalAvailable}</p>
                        <p className="mt-0.5 text-xs text-slate-400">Ready for borrowing (Active)</p>
                    </div>
                    ...
                    <div className="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm">
                        ...
                        <p className="mt-2 text-2xl font-extrabold text-slate-900">{activeBooksCount}</p>
                        <p className="mt-0.5 text-xs text-slate-400">In circulation status</p>
                    </div>
                </div>
                        ...
                        <div className="mt-6 grid grid-cols-1 gap-5 md:grid-cols-2">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea
                                    ...
                                    className="w-full resize-none rounded-xl border border-slate-200 bg-slate-50/50 px-4 py-2.5 text-sm text-slate-900 placeholder:text-slate-400 outline-none transition-all focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-500/15"
                                />
                            </div>
                        </div>
                ...
                {/* ── Edit Book Form Card ── */}
                {editingBook && (
                    <div className="overflow-hidden rounded-2xl border border-sky-200/80 bg-white p-6 sm:p-7 shadow-lg shadow-sky-100/50 animate-in fade-in zoom-in-95 duration-200">
                        <div className="flex items-center justify-between border-b border-slate-100 pb-4">
                            <div>
                                <h2 className="text-lg font-bold text-slate-900">
                        ...
                        <div className="mt-6 flex flex-col-reverse gap-2.5 border-t border-slate-100 pt-4 sm:flex-row sm:justify-end">
                            ...
                            <button
                                ...
                                className="rounded-xl bg-gradient-to-r from-sky-600 to-indigo-600 px-6 py-2 text-xs sm:text-sm font-semibold text-white shadow-md shadow-sky-200/60 transition-all hover:shadow-lg active:scale-95"
                            >
                                Update Book
                            </button>
                        </div>
                    ...
                    <div className="overflow-x-auto">
                        <table className="w-full min-w-[1150px] text-left text-sm">
                            ...
                            {filteredBooks.map((book) => {
                                ...
                                const hasStock = (book.availableQuantity || 0) > 0;
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 font-mono text-xs text-slate-600">
                                            <span className="rounded bg-slate-100 px-2 py-0.5 border border-slate-200/80">
                                                {book.isbn}
                                            </span>
                                        </td>
                                        ...
                                        {/* Cột Available: Sách INACTIVE sẽ hiển thị là 0 kèm badge xám */}
                                        <td className="px-6 py-4 text-center">
                                            ...
                                            >
                                                {isActive ? book.availableQuantity : 0}
                                            </span>
                                        </td>
                            ...
                            {filteredBooks.length === 0 && (
                                <tr>
                                    ...
                                    >
                                        ...
                                        <p className="mt-3 text-sm font-semibold text-slate-700">No books found</p>
                                        <p className="mt-1 text-xs text-slate-400">Try adjusting your search query or add a new title.</p>
                                    </td>
                                </tr>
                            )}
                            </tbody>
