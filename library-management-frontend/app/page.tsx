        ...
        <div className="min-h-screen bg-slate-50 p-6 sm:p-8 lg:p-10">
          <div className="mx-auto max-w-7xl space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <div className="flex items-center gap-2 self-start sm:self-auto rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-xs font-medium text-slate-600 shadow-sm">
            ...
            {/* ── 5 Main Statistics Cards (Grid 5 cột cân đối) ── */}
            <div className="grid gap-5 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
              ...
              <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-100/50">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">
                  ...
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-indigo-50 text-indigo-600 border border-indigo-100 transition-colors group-hover:bg-indigo-600 group-hover:text-white">
              ...
              <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:border-sky-200 hover:shadow-lg hover:shadow-sky-100/50">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-sky-50 text-sky-600 border border-sky-100 transition-colors group-hover:bg-sky-600 group-hover:text-white">
                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:border-violet-200 hover:shadow-lg hover:shadow-violet-100/50">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-violet-50 text-violet-600 border border-violet-100 transition-colors group-hover:bg-violet-600 group-hover:text-white">
                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              {/* 5. Borrowings (Thẻ mới được tích hợp vào hàng) */}
              <div className="group relative overflow-hidden rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:border-amber-200 hover:shadow-lg hover:shadow-amber-100/50">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-amber-50 text-amber-600 border border-amber-100 transition-colors group-hover:bg-amber-600 group-hover:text-white">
                    <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path
                          strokeLinecap="round"
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <span className="text-3xl font-extrabold tracking-tight text-slate-900">
                      ...
                      <span className="text-sm font-bold text-emerald-600">VND</span>
                    </div>
                  ...
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-100/70 text-emerald-700 font-bold text-xl shadow-sm">
                    ₫
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <span className="text-3xl font-extrabold tracking-tight text-slate-900">
                      ...
                      <span className="text-sm font-bold text-sky-600">VND</span>
                    </div>
                  ...
                  <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-sky-100/70 text-sky-700 font-bold text-xl shadow-sm">
                    ₫
                  </div>
                </div>
              </div>
            ...
            <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-sm sm:p-7">
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                ...
                <div className="rounded-xl border border-slate-200/70 bg-slate-50/60 p-5 transition-all hover:bg-slate-50">
                  ...
                  <p className="mt-3 text-2xl sm:text-3xl font-extrabold tracking-tight text-slate-900">
                    {dashboard?.totalUsers ?? 0}
                  </p>
                  <p className="mt-1 text-xs text-slate-400">All registered roles</p>
                </div>
                ...
                <div className="rounded-xl border border-emerald-200/60 bg-emerald-50/30 p-5 transition-all hover:bg-emerald-50/50">
                  ...
                  <p className="mt-3 text-2xl sm:text-3xl font-extrabold tracking-tight text-emerald-950">
                    {dashboard?.activeUsers ?? 0}
                  </p>
                  <p className="mt-1 text-xs text-emerald-600/80">Normal operations</p>
                </div>
                ...
                <div className="rounded-xl border border-rose-200/60 bg-rose-50/30 p-5 transition-all hover:bg-rose-50/50">
                  ...
                  <p className="mt-3 text-2xl sm:text-3xl font-extrabold tracking-tight text-rose-950">
                    {dashboard?.inactiveUsers ?? 0}
                  </p>
                  <p className="mt-1 text-xs text-rose-600/80">Disabled / Suspended</p>
                </div>
