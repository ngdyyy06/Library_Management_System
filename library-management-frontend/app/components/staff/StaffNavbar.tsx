            ...
            icon: (
                ...
                >
                    <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth={1.5}
                        d="M4 19.5A2.5 2.5 0 016.5 17H20M6.5 2H20v15H6.5A2.5 2.5 0 014 14.5v-10A2.5 2.5 0 016.5 2z"
                    />
                </svg>
            ),
        },
                ...
                <div className="flex items-center gap-3 border-b border-slate-100 px-5 py-4">
                    ...
                    <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-0.5 flex items-center gap-1.5">
                            ...
                            <span className="rounded bg-slate-100 px-1.5 py-0.2 text-[10px] font-medium tracking-wide text-slate-600">
                                Staff
                            </span>
                        </div>
                    </div>
                                ...
                                >
                                    ...
                                    {item.notification &&
                                        pendingRequestCount > 0 && (
                                            <span className="absolute -right-2.5 -top-2 flex min-w-[16px] h-4 items-center justify-center rounded-full bg-red-500 px-1 text-[9px] font-bold leading-none text-white shadow-sm ring-2 ring-white">
                                                {pendingRequestCount >
                                                99
                                                    ? "99+"
                                                    : pendingRequestCount}
